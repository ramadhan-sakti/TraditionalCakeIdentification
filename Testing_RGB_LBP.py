# -*- coding: utf-8 -*-
"""
Created on Wed Dec 11 20:57:13 2019
...
for index, row in FeatureSet_Training.iterrows():
    #Append Fitur
    FiturTraining_RGB_LBP.append([row['meanR'], row['meanG'], row['meanB'], row['meanLBP'],
...
for index, row in FeatureSet_Testing.iterrows():
    #Append Fitur
    FiturTesting_RGB_LBP.append([row['meanR'], row['meanG'], row['meanB'], row['meanLBP'],
          row['stdR'], row['stdG'], row['stdB'], row['stdLBP'],
          row['skewR'], row['skewG'], row['skewB'], row['skewLBP']])
    #Append Target
