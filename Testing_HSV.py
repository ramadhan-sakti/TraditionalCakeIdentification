# -*- coding: utf-8 -*-
"""
Created on Tue Dec 24 17:21:31 2019
...
for index, row in FeatureSet_Training.iterrows():
    #Append Fitur
    FiturTraining_HSV_LBP.append([row['meanH'], row['meanS'], row['meanV'],
...
for index, row in FeatureSet_Testing.iterrows():
    #Append Fitur
    FiturTesting_HSV_LBP.append([row['meanH'], row['meanS'], row['meanV'],
          row['stdH'], row['stdS'], row['stdV'],
          row['skewH'], row['skewS'], row['skewV']])
    #Append Target
