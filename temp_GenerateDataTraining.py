# -*- coding: utf-8 -*-
"""
Created on Mon Dec 23 19:10:32 2019
...
listDadarGulung = [9,15,18,51,55,58,61,64,70,79,80,86,89,92,96,99,105,109,113,
                   116,119,120,122,127,130,132,143,146,152,155,157,159,1161,
                   163,172,177]
...
DataTesting = pd.read_excel("Data/DataTesting_Random.xlsx")
NamaItem = DataTesting[:]['Nama Item'].tolist()
indexToDrop = []

for index, row in FeatureSet_All.iterrows():
    if(FeatureSet_All.iloc[index]['Nama Item'] in NamaItem):
        indexToDrop.append(index)
        
DataTraining = FeatureSet_All.drop(indexToDrop)
    
endTime = datetime.datetime.now()
deltaTime = endTime-startTime

DataTraining.to_excel('DataTraining_Random_1.xlsx')