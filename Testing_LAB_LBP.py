# -*- coding: utf-8 -*-
"""
Created on Wed Dec 18 22:50:47 2019
...
for index, row in FeatureSet_Testing.iterrows():
    ...
    FiturTesting_LAB_LBP.append([row['meanlabL'], row['meanlabA'], row['meanlabB'],
                                 row['meanLBP'],row['stdlabL'], row['stdlabA'], 
                                 row['stdlabB'], row['stdLBP'],row['skewlabL'], 
                                 row['skewlabA'], row['skewlabB'], row['skewLBP']])
    #Append Target
